...
try {
    ...
    if ($failures.Count -eq 0) {
        ...
        Assert-Contains $failures $qualityRunwayPath 'Go backend routes | `287` route registrations' 'quality runway Go route baseline drift'
        ...
        Assert-Contains $failures $backendCapabilityRunbookPath '| Capability rows | `38` |' 'backend capability runbook capability count drift'
