...
$evidencePattern = "git diff --check|test-codex-hooks\.ps1|check-agent-governance\.ps1|go test|npm run|vue-tsc|smoke|PASS:|FAIL|exit 0|Exit code: 0|passed|not verified|$notVerifiedWord"
