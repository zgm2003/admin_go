...
Verified at: 2026-06-06 23:10:31 +08:00
...
| Database | `admin` |
| Base tables | 56 |
| Full DDL artifact | `docs/db/mysql-live-schema-2026-06-06.sql` |
...
| `cron_task_log` | 89331 | InnoDB | utf8mb4_0900_ai_ci | 定时任务执行日志表 |
