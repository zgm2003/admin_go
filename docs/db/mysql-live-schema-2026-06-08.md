...
| Database | `admin` |
| Base tables | 55 |
| Full DDL artifact | `docs/db/mysql-live-schema-2026-06-08.sql` |
...
| `permissions` | 362 | InnoDB | utf8mb4_0900_ai_ci | 菜单权限表 |
| `role_permissions` | 449 | InnoDB | utf8mb4_0900_ai_ci | role permission pivot |
...
| `upload_driver` | 56 | InnoDB | utf8mb4_0900_ai_ci |  |
| `upload_rule` | 56 | InnoDB | utf8mb4_0900_ai_ci |  |
| `upload_setting` | 58 | InnoDB | utf8mb4_0900_ai_ci | 上传设置：驱动+规则组合与启用状态 |
| `user_profiles` | 4 | InnoDB | utf8mb4_0900_ai_ci | 用户资料表 |
| `user_sessions` | 285 | InnoDB | utf8mb4_0900_ai_ci | 用户会话表 |
| `user_wallets` | 2 | InnoDB | utf8mb4_unicode_ci |  |
| `users` | 4 | InnoDB | utf8mb4_0900_ai_ci | 用户表 |
| `users_login_log` | 364 | InnoDB | utf8mb4_0900_ai_ci | 登录日志 |
...
| ---: | --- | --- | --- | --- | --- | --- | --- |
| 1 | `id` | `bigint unsigned` | NO | PRI | NULL | auto_increment |  |
| 2 | `user_id` | `bigint unsigned` | NO | MUL | 0 |  |  |
| 3 | `slug` | `varchar(191)` | NO |  | NULL |  |  |
| 4 | `type` | `varchar(16)` | NO | MUL | NULL |  |  |
| 5 | `category` | `varchar(191)` | NO |  |  |  |  |
| 6 | `title` | `varchar(191)` | NO |  | NULL |  |  |
| 7 | `cover_url` | `varchar(1024)` | NO |  |  |  |  |
| 8 | `description` | `varchar(512)` | NO |  |  |  |  |
| 9 | `content` | `text` | YES |  | NULL |  |  |
| 10 | `url` | `varchar(1024)` | NO |  |  |  |  |
| 11 | `tags_json` | `json` | YES |  | NULL |  |  |
| 12 | `status` | `tinyint` | NO | MUL | 1 |  |  |
...
- `idx_ai_assets_user_status_updated` (non-unique, BTREE): `user_id`, `status`, `is_del`, `updated_at`, `id`
- `PRIMARY` (unique, BTREE): `id`
- `uk_ai_assets_user_slug` (unique, BTREE): `user_id`, `slug`
