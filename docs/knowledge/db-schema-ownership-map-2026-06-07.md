...
Generated at: 2026-06-07 02:03:52 +08:00
...
| --- | ---: | --- | --- | --- |
| `canvas_prompts_backup_20260601_before_infinite_import` | `0` | `live-schema-only` |  |  |
...
| `ai_conversations` | `4` | `go-model` | `ai/chat`, `ai/conversation`, `ai/message` | `ai/chat`, `ai/conversation`, `ai/message`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/conversation:admin_back_go/internal/module/ai/conversation/model.go`<br>`ai/message:admin_back_go/internal/module/ai/message/model.go` | AI会话 |
| `ai_image_assets` | `15` | `go-model` | `ai/image` | `ai/image` | `ai/image:admin_back_go/internal/module/ai/image/model.go` | AI图片资产 |
| `ai_image_task_assets` | `15` | `go-model` | `ai/image` | `ai/image` | `ai/image:admin_back_go/internal/module/ai/image/model.go` | AI图片任务资产关系 |
| `ai_image_tasks` | `25` | `go-model` | `ai/image` | `ai/image` | `ai/image:admin_back_go/internal/module/ai/image/model.go` | AI图片生成任务 |
...
| `ai_knowledge_retrieval_hits` | `24` | `go-model` | `ai/knowledge` | `ai/knowledge`, `ai/run` | `ai/knowledge:admin_back_go/internal/module/ai/knowledge/model.go` | AI知识库检索命中 |
| `ai_knowledge_retrievals` | `4` | `go-model` | `ai/knowledge` | `ai/knowledge`, `ai/run` | `ai/knowledge:admin_back_go/internal/module/ai/knowledge/model.go` | AI知识库检索记录 |
| `ai_messages` | `53` | `go-model` | `ai/chat`, `ai/message` | `ai/chat`, `ai/conversation`, `ai/message`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/message:admin_back_go/internal/module/ai/message/model.go` | AI消息 |
...
| `ai_run_events` | `38` | `go-model` | `ai/chat`, `ai/run` | `ai/chat`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/run:admin_back_go/internal/module/ai/run/model.go` | AI运行监控事件 |
| `ai_runs` | `19` | `go-model` | `ai/chat`, `ai/run` | `ai/chat`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/run:admin_back_go/internal/module/ai/run/model.go` | AI运行监控记录 |
| `ai_tool_calls` | `1` | `go-model` | `ai/tool` | `ai/run`, `ai/tool` | `ai/tool:admin_back_go/internal/module/ai/tool/model.go` | AI工具调用记录 |
...
| `cron_task_log` | `89547` | `go-model` | `crontask` | `crontask` | `crontask:admin_back_go/internal/module/crontask/model.go` | 定时任务执行日志表 |
...
| `operation_logs` | `2410` | `go-model` | `operationlog` | `operationlog` | `operationlog:admin_back_go/internal/module/operationlog/model.go` | 操作日志表 |
...
| `permissions` | `315` | `go-model` | `permission` | `permission`, `role`, `user` | `permission:admin_back_go/internal/module/permission/model.go`<br>`permission:admin_back_go/internal/module/permission/repository.go` | 菜单权限表 |
| `role_permissions` | `390` | `go-model` | `permission`, `role` | `permission`, `role` | `permission:admin_back_go/internal/module/permission/model.go`<br>`role:admin_back_go/internal/module/role/model.go` | role permission pivot |
...
| `user_sessions` | `215` | `go-model` | `auth` | `auth` | `auth:admin_back_go/internal/module/auth/session.go` | 用户会话表 |
...
| `users_login_log` | `294` | `go-model` | `auth` | `auth` | `auth:admin_back_go/internal/module/auth/loginlog.go`<br>`auth:admin_back_go/internal/module/auth/model.go` | 登录日志 |
