...
Generated at: 2026-06-08 06:10:32 +08:00
...
| --- | ---: | --- | --- | --- |
| `canvas_assets` | `0` | `live-schema-only` |  | 无限画布素材公共库 |
| `canvas_prompts` | `1356` | `live-schema-only` |  | 无限画布提示词公共库 |
...
| `ai_assets` | `0` | `go-model` | `ai/asset` | `ai/asset` | `ai/asset:admin_back_go/internal/module/ai/asset/model.go` | AI素材库 |
...
| `ai_image_files` | `2` | `go-model` | `ai/image` | `ai/image` | `ai/image:admin_back_go/internal/module/ai/image/model.go` |  |
| `ai_image_tasks` | `1` | `go-model` | `ai/image` | `ai/image` | `ai/image:admin_back_go/internal/module/ai/image/model.go` |  |
...
| `ai_run_events` | `4` | `go-model` | `ai/chat`, `ai/run` | `ai/chat`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/run:admin_back_go/internal/module/ai/run/model.go` | AI运行监控事件 |
| `ai_runs` | `2` | `go-model` | `ai/chat`, `ai/run` | `ai/chat`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/run:admin_back_go/internal/module/ai/run/model.go` | AI运行监控记录 |
...
| `cron_task_log` | `94330` | `go-model` | `crontask` | `crontask` | `crontask:admin_back_go/internal/module/crontask/model.go` | 定时任务执行日志表 |
...
| `operation_logs` | `2501` | `go-model` | `operationlog` | `operationlog` | `operationlog:admin_back_go/internal/module/operationlog/model.go` | 操作日志表 |
...
| `permissions` | `341` | `go-model` | `permission` | `permission`, `role`, `user` | `permission:admin_back_go/internal/module/permission/model.go`<br>`permission:admin_back_go/internal/module/permission/repository.go` | 菜单权限表 |
| `role_permissions` | `437` | `go-model` | `permission`, `role` | `permission`, `role` | `permission:admin_back_go/internal/module/permission/model.go`<br>`role:admin_back_go/internal/module/role/model.go` | role permission pivot |
...
| `upload_driver` | `53` | `go-model` | `uploadconfig` | `ai/image`, `clientversion`, `export`, `shared/validate`, `uploadconfig`, `uploadtoken` | `uploadconfig:admin_back_go/internal/module/uploadconfig/model.go` |  |
| `upload_rule` | `53` | `go-model` | `uploadconfig` | `ai/image`, `clientversion`, `export`, `uploadconfig`, `uploadtoken` | `uploadconfig:admin_back_go/internal/module/uploadconfig/model.go` |  |
| `upload_setting` | `55` | `go-model` | `uploadconfig` | `ai/image`, `clientversion`, `export`, `uploadconfig`, `uploadtoken` | `uploadconfig:admin_back_go/internal/module/uploadconfig/model.go` | 上传设置：驱动+规则组合与启用状态 |
| `user_profiles` | `4` | `go-model` | `user` | `auth`, `user` | `user:admin_back_go/internal/module/user/model.go` | 用户资料表 |
| `user_sessions` | `247` | `go-model` | `auth` | `auth` | `auth:admin_back_go/internal/module/auth/session.go` | 用户会话表 |
...
| `users_login_log` | `326` | `go-model` | `auth` | `auth` | `auth:admin_back_go/internal/module/auth/loginlog.go`<br>`auth:admin_back_go/internal/module/auth/model.go` | 登录日志 |
