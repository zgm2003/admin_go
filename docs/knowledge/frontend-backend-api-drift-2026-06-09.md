...
Generated at: 2026-06-09 20:11:39 +08:00
...
| Backend route registrations available | `288` |
| Active backend admin/canvas routes | `278` |
| Frontend exact backend API calls compared | `267` |
| Distinct frontend exact method/path keys | `259` |
| frontend-route-match | `267` |
...
| Frontend blob/download calls excluded from exact matching | `3` |
