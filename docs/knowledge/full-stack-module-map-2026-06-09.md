...
Generated at: 2026-06-09 20:12:07 +08:00

Backend route inventory: `docs/knowledge/backend-route-inventory-2026-06-09.md`
Frontend API inventory: `docs/knowledge/frontend-api-inventory-2026-06-09.md`
DB schema ownership map: `docs/knowledge/db-schema-ownership-map-2026-06-08.md`
API source-only route review: `docs/knowledge/api-source-only-route-review-2026-06-09.md`
...
| Fact | Value |
| --- | --- |
| Backend route inventory artifact | `docs/knowledge/backend-route-inventory-2026-06-09.md` |
| Frontend API inventory artifact | `docs/knowledge/frontend-api-inventory-2026-06-09.md` |
| DB schema ownership artifact | `docs/knowledge/db-schema-ownership-map-2026-06-08.md` |
| API source-only review artifact | `docs/knowledge/api-source-only-route-review-2026-06-09.md` |
| Backend route registrations joined | `288` |
| Frontend exact backend API calls assigned | `267` |
...
| backend surface `canvas` routes | `32` |
| frontend `admin_front_ts` exact backend calls | `240` |
| frontend `canvas_front_next` exact backend calls | `27` |
...
| `ai/video` | `canvas=4` | `canvas_front_next=4` | `canvas_video_tasks` |  |  |
...
```text
exact frontend backend calls = 267
assigned frontend backend calls = 267
