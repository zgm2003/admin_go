...
Generated at: 2026-06-08 11:48:57 +08:00
...
| `ai_run_events` | `6` | `go-model` | `ai/chat`, `ai/run` | `ai/chat`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/run:admin_back_go/internal/module/ai/run/model.go` | AI运行监控事件 |
| `ai_runs` | `3` | `go-model` | `ai/chat`, `ai/run` | `ai/chat`, `ai/run` | `ai/chat:admin_back_go/internal/module/ai/chat/model.go`<br>`ai/run:admin_back_go/internal/module/ai/run/model.go` | AI运行监控记录 |
...
| `cron_task_log` | `94964` | `go-model` | `crontask` | `crontask` | `crontask:admin_back_go/internal/module/crontask/model.go` | 定时任务执行日志表 |
...
| `operation_logs` | `2585` | `go-model` | `operationlog` | `operationlog` | `operationlog:admin_back_go/internal/module/operationlog/model.go` | 操作日志表 |
