...
AI conversation focused gates cover aiconversation/aimessage/aichat REST/service contracts plus frontend AI REST/WebSocket event contract tests; airun gate covers token-only `ai_runs` / `ai_run_events` monitor reads and aggregates
